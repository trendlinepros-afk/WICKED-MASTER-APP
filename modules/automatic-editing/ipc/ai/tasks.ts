/**
 * The routed AI tasks: retake detection (stage 1), cut review (stage 2),
 * graphic planning + slot filling (stage 4), and revision-instruction parsing
 * (review loop). Each builds a strict-JSON prompt, calls the router, and
 * safely parses.
 */
