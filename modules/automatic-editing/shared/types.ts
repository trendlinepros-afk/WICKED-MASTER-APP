/**
 * Automatic Editing shared types — the EDL (edit decision list) data model,
 * project state, pipeline stages, AI routing, and render queue contracts.
 *
...
/** Secrets stored via Electron safeStorage — names shared by main + renderer. */
...
export interface AppSettings {
   ...
   *  a default under the module's user-data directory is used. */
  projectsDir?: string
