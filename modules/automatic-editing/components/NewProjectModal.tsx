...
export default function NewProjectModal({ busy, onConfirm, onCancel }: Props) {
  ...
  return (
    <div
      ...
      aria-modal="true"
    >
      <div className={`${panel} bg-raised w-full max-w-md p-6`} onClick={(e) => e.stopPropagation()}>
        <h2 className="text-lg font-bold text-ink mb-1">Name your project</h2>
        ...
        <div className="flex justify-end gap-2 mt-5">
          ...
          <button className={btnPrimary} onClick={confirm} disabled={!trimmed || busy}>
